...
const Container = tw.div`flex flex-column max-w-[30rem] items-center content-between justify-evenly mt-[2rem] ml-auto mb-auto mr-auto border-2 border-solid shadow-xl rounded-3xl h-20 bg-gradient-to-r from-blue-500 via-blue-700 to-blue-900 text-white
`;
const BookNow = tw.button`rounded-xl w-[10rem] h-10 border-[1px] border-solid border-white bg-gradient-to-r from-orange-500 via-red-700 to-pink-900 text-white shadow-gray-800
`;
...
`;
const Button1 = tw.button`rounded-xl w-[6rem] h-7 border-1 border-solid border-black bg-gradient-to-r from-orange-500 via-oranage-700 to-pink-700 text-white shadow-xl
`;
const TestButton1 = tw.button`rounded-xl w-[6rem] h-7 border-[1px] border-solid bg-white text-black shadow-xl
`;
const Button2 = tw.button`rounded-xl w-[6rem] h-7 border-[1px] border-solid shadow-xl bg-white text-black
`;
...
`;
const Button3 = tw.button`rounded-xl w-[8rem] h-7 border-1 border-solid border-black bg-gradient-to-r from-[#A90189] via-[#64067A] to-[#4B0875] text-white
`;
